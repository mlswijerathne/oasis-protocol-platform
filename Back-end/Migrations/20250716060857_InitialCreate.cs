    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlgorithmicProblems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlgorithmicProblems_Challenges_ChallengeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildathonProblems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildathonProblems_Challenges_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "Challenges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    ChallengeId = table.Column<int>(type: "int", nullable: false),
                    AlgorithmicCompleted = table.Column<bool>(type: "bit", nullable: false),
                    BuildathonUnlocked = table.Column<bool>(type: "bit", nullable: false),
                    BuildathonCompleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlgorithmicProblems_ChallengeId",
                table: "AlgorithmicProblems",
                column: "ChallengeId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildathonProblems_ChallengeId",
                table: "BuildathonProblems",
                column: "ChallengeId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamChallenges_TeamId_ChallengeId",
                table: "TeamChallenges",
